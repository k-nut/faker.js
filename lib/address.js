...
function Address (faker) {
  ...
  this.streetName = function () {
      return f(faker.random.arrayElement(faker.definitions.address.street_name));
  }
  ...
  this.buildingNumber = function () {
    return Helpers.replaceSymbols(faker.random.arrayElement(faker.definitions.address.building_number));
  }
   ...
   * @method faker.address.streetName
   */
  this.streetRoot = function () {
    return faker.random.arrayElement(faker.definitions.address.street_root);
  }
  ...
  this.streetAddress = function (useFullAddress) {
    return f(faker.random.arrayElement(faker.definitions.address.street_address));
