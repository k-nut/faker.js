...
function Faker (opts) {
  ...
  var _definitions = {
    ...
    "address": ["city_prefix", "city_suffix", "street_suffix", "county", "country", "country_code", "state", "state_abbr", "street_prefix", "postcode", "postcode_by_state", "direction", "direction_abbr", "street_root", "street_name", "street_address", "building_number"],
